...
Проект текстовой социальной сети.
После авторизации пользователю доступна возможность публиковать посты в разных категориях с фото,подписываться на любимых авторово, а также участвовать в обсуждениях в комментариях под постами других пользователей. Помимо этого, есть возможность читать посты по определенным категориям.
